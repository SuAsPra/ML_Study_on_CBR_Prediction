...
# =====================================================
# SAVE EVERYTHING (NEW NAMES)
# =====================================================

joblib.dump(final_model, "final_cbr_model_with_pl.pkl")
joblib.dump(imputer, "imputer_with_pl.pkl")
joblib.dump(features, "features_with_pl.pkl")

print("\nFINAL MODEL WITH PL SAVED!")
print("Files created:")
print("- final_cbr_model_with_pl.pkl")
print("- imputer_with_pl.pkl")
print("- features_with_pl.pkl")
